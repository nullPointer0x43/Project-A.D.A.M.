...
|Median | The exact middle value of the dataset when arranged in ascending order. | $\tilde{x} = \begin{cases} x_{\frac{n+1}{2}} & n \text{ is odd} \\ \frac{x_{\frac{n}{2}} + x_{\frac{n}{2}+1}}{2} & n \text{ is even} \end{cases}$ |
